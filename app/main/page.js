...
export default function Main() {
  ...
  return (
    <div className="h-screen w-screen bg-gray-900 relative overflow-hidden flex flex-col">
      ...
      {/* MAIN CONTENT - FLEX-1 STRUCTURE */}
      <main className="relative z-50 flex-1 flex flex-col items-center justify-center pt-24 px-4 overflow-y-auto">
        <div className="flex flex-col items-center gap-6 max-w-lg w-full mx-auto bg-white/10 rounded-2xl border border-white/20 shadow-2xl px-6 py-12">
          ...
          <label
            htmlFor="file-upload"
            className="cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-md px-6 py-3 text-center select-none transition duration-300 w-full max-w-sm"
          >
